...
void graj_w_zgadywanie(string& imie) {
    ...
    vector<string> tekstyZaMalo = {
        "Za malo!",
        "Celuj wyzej!",
        "Moja liczba jest wieksza.",
        "W gore! To jeszcze nie to.",
        "Pudlo! Sprobuj wiekszej liczby.",
        "To zdecydowanie zbyt mala liczba."
    };

    vector<string> tekstyZaDuzo = {
        "Za duzo!",
        "Przesadziles! Mniej.",
        "Moja liczba jest mniejsza.",
        "W dol! Troche cie ponioslo.",
        "Odejmij troche, to zbyt wysoka liczba.",
        "Nie tak wysoko! Celuj nizej."
    };
    ...
    do {
        ...
        do {
            ...
            if (strzal < liczba) {
                int index = rand() % tekstyZaMalo.size();
                cout << tekstyZaMalo[index] << "\n" << endl;
            }
            else if (strzal > liczba) {
                int index = rand() % tekstyZaDuzo.size();
                cout << tekstyZaDuzo[index] << "\n" << endl;
            }
            else {
                cout << "\n**Brawo! Trafiles!**\n" << endl;
            }
...
int main() {
    ...
    do {
        ...
        if (!czyGrano) {
            cout << "|      (Zablokowane - zagraj 1 gre )  |" << endl;
        }
        else {
            cout << "|                                     |" << endl;
        }
        ...
        case 2:
            if (czyGrano) {
                ...
                cout << "\n[!] DOSTEP ZABLOKOWANY! [!]" << endl;
                cout << "Musisz zagrac przynajmniej raz, aby zobaczyc tabele wynikow." << endl;
